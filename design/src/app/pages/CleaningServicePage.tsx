...
export default function CleaningServicePage() {
  ...
  const galleryImages = [
    {
      src: 'https://i.imgur.com/rVEuPXV.png',
      alt: '입주 청소 사례 1'
    },
    {
      src: 'https://i.imgur.com/FjxFSZo.png',
      alt: '입주 청소 사례 2'
    },
    {
      src: 'https://i.imgur.com/0Gltfr3.png',
      alt: '입주 청소 사례 3'
    },
    {
      src: 'https://i.imgur.com/QZ6nE5u.png',
      alt: '입주 청소 사례 4'
    },
    {
      src: 'https://i.imgur.com/rxvS5DG.png',
      alt: '입주 청소 사례 5'
    },
    {
  ...
  const procedures = [
    ...
    },
    {
      icon: Sparkles,
      title: '입주 청소 진행',
      description: '전문 청소팀이 방문하여 꼼꼼하게 청소합니다',
      color: 'from-teal-500 to-emerald-500'
    },
    {
      icon: ClipboardCheck,
      title: '완료 후 내용확인 전달',
      description: '청소 완료 후 결과를 상세히 전달드립니다',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] mt-20 overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://i.imgur.com/td4FHbI.png"
            alt="종합 청소 서비스"
        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            ...
            >
              ...
              >
                입주 전 완벽한 청소로 새 출발을 준비하세요.<br className="hidden sm:block" />
                구석구석 깨끗하게! 전문 청소팀이 책임집니다!
              </motion.p>
      ...
      {/* Section 2: Why Cleaning is Important */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            ...
            >
              ...
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src="https://i.imgur.com/18bYezV.png"
                  alt="입주 청소의 중요성"
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4 text-base sm:text-lg text-gray-700 leading-relaxed">
                <p>
                  새 아파트라도 <span className="font-bold text-blue-600">공사 먼지와 이물질</span>이 곳곳에 남아있어 철저한 청소가 필요합니다.
                </p>
                <p>
                  특히 창틀, 벽지 틈새, 시스템 에어컨 등 <span className="font-bold text-blue-600">손이 닿기 어려운 곳</span>까지 깨끗하게 해야 합니다.
                </p>
                <p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4 text-base sm:text-lg text-gray-700 leading-relaxed">
                <p>
                  <span className="font-bold text-blue-600">숙련된 전문 청소팀</span>이 체계적인 프로세스로 빠짐없이 청소합니다.
                </p>
                <p>
                  거실, 방, 주방, 욕실은 물론 <span className="font-bold text-blue-600">베란다, 창틀, 환풍구</span>까지 세심하게 관리합니다.
                </p>
                <p>
                  친환경 세제와 전문 장비를 사용하여 <span className="font-bold text-blue-600">안전하고 효과적</span>으로 청소합니다.
                </p>
                <div className="bg-blue-50 p-4 sm:p-6 rounded-lg">
                  <p className="font-bold text-blue-900">
                    ✨ 만족 보증!<br />
                    <span className="font-normal text-sm sm:text-base">청소 결과가 만족스럽지 않으면 재청소해드립니다.</span>
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src="https://i.imgur.com/IT77FT2.png"
                  alt="전문 청소 서비스"
                  className="w-full h-auto"
                />
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-10 leading-relaxed">
              입주 전 완벽한 청소로 새로운 시작을 준비하세요.<br className="hidden sm:block" />
              전문 청소팀이 구석구석 깨끗하게 만들어드립니다!
            </p>
